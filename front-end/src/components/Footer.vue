<template>
  <div id="footer">
    <div class="InnerSection">
      <!-- Add Logo -->
      <h2 class="title">Michael Studio</h2>
      <p class="introduce">
        歡迎來到Michael的教學工作室，主辦人林彥文，名Michael，創立理念為『分享』並且期盼各位學員能在此找到分享的快樂，同時完成理想。
      </p>
      <p class="introduce">---A lazy youth, a lousy age.----</p>
    </div>
    <div class="InnerSection">
      <h2 class="InnerHeading">About</h2>
      <ol>
        <li>
          <a href="#">About us</a>
        </li>
    ...
    <div class="InnerSection">
      ...
      <ol>
        <li>
          <a href="#" target="_blank">Title-1</a>
        </li>
        <li>
          <a href="#" target="_blank">Title-2</a>
        </li>
        <li>
          <a href="#" target="_blank">Title-3</a>
        </li>
      </ol>
    </div>
    <div class="InnerSection">
      ...
      <ol id="IconList">
        <li>
          <a href="https://www.instagram.com/yan_wun/" target="_blank">
            <img
              class="SocialIcon"
        ...
        <li>
          <a href="https://www.facebook.com/profile.php?id=100001081552642" target="_blank">
            <img
              class="SocialIcon"
    ...
    <div class="copyRight">
      @Copyright 2020.02.05 Michael Lin
    </div>
  </div>
</template>
